    ...
    switch (req) {
        case 'createTicket': {
            ...
            selectMenu.addOptions([
                ...
                },
                {
                    emoji: '📌',
                    label: 'Pmco Role',
                    description: 'Open a ticket for Pmco Role',
                    value: 'newTicket_Destek'
                },
                {
                    emoji: '🛡️',
                    label: 'Destek/Contact',
                    description: 'talk to the authorities',
            ...
            return int.reply({ content: 'Choose a reason for the ticket?', components: [row], ephemeral: true });
        }
        ...
        case 'newTicket': {
            ...
            if (!channel) {
                ...
                ticketEmbed.setAuthor(`Ticket Successfully Created ${int.member.user.username} ${reason ? ` (${reason})` : ''} ✅`);
                ticketEmbed.setDescription('*Click the reaction below to close the current ticket, attention, you will not be able to return!*');
                ...
                return int.update({ content: `Ticket opened <@${int.member.id}> <#${channel.id}> ✅`, components: [], ephemeral: true });
            } else {
        ...
        case 'reopenTicket': {
            ...
            ticketEmbed.setColor('GREEN');
            ticketEmbed.setAuthor(`Ticket reopened ✅`);
